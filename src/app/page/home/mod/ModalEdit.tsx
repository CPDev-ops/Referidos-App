        ...
        <div className="space-y-6">
            ...
            >
                <div className="space-y-4">
                    <div>
                        <label className="text-sm  text-[var(--text-200)]">Fecha</label>
                        <input
                            type="date"
                    ...
                    <div>
                        <label className="text-sm  text-[var(--text-200)]">Legajo</label>
                        <input
                            type="number"
                            min={0}
                            {...register("legajo", {
                    ...
                    <div>
                        <label className="text-sm  text-[var(--text-200)]">Nombre y apellido</label>
                        <input
                            type="text"
                    ...
                    <div>
                        <label className="text-sm  text-[var(--text-200)]">Detalle</label>
                        <textarea
                            {...register("detalle")}
                            className={`${inputStyle}`}
                            rows={3}
                    ...
                    <div>
                        <label className="text-sm  text-[var(--text-200)]">N° Variación</label>
                        <input
                            type="number"
                            min={0}
                    ...
                    <div>
                        <label className="text-sm  text-[var(--text-200)]">Tipo de variación</label>
                        <input
                            type="text"
                    ...
                    <div>
                        <label className="text-sm  text-[var(--text-200)]">Sobrante</label>
                        <input
                            type="number"
                            min={0}
                            {...register("sobrante", {
                    ...
                    <div>
                        <label className="text-sm  text-[var(--text-200)]">Faltante</label>
                        <input
                            type="number"
                            min={0}
                            {...register("faltante", {
